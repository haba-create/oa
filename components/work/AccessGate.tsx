    ...
    <>
      ...
      <main>
        <section className="gate">
          <p className="caps">SELECTED WORK / PRIVATE ACCESS</p>
          <h1 className="head">THIS WORK IS<br />SHARED PRIVATELY.</h1>
          ...
          {denied && <p className="gate__error caps" role="alert">THAT CODE DIDN&rsquo;T MATCH. TRY AGAIN, OR EMAIL ME FOR A NEW ONE.</p>}
